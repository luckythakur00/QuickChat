    ...
    <div className='h-full lg:flex' >
      ...
      <div className='h-full md:h-[50%] lg:h-full w-full lg:w-1/2 pt-4 md:pt-0 flex flex-col md:justify-center items-center md:gap-4' >
        ...
        <form onSubmit={handleLogin} method='post' className='w-[90%] sm:w-full sm:flex flex-col justify-center items-center text-base sm:text-lg'>
          ...
          <button type='submit' className={`h-11 md:h-10 w-full sm:w-96 mt-2 rounded-md font-bold text-lg text-black ${darkMode ? 'bg-green-600 shadow-sm shadow-white/50' : 'bg-[#945ecd] shadow-black/30 md:bg-purple-600 shadow-md md:shadow-purple-500'}`} >Log In</button>
        </form>
